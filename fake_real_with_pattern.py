...
def load_models_and_tokenizers(bert_model_name, roberta_model_name):
...
bert_tokenizer, bert_model, roberta_tokenizer, roberta_model = load_models_and_tokenizers(bert_model_name, roberta_model_name)
...
# Predict fake/real news and calculate probabilities
